...
throw Error("You must call R7Insight.init(...) first.");};return{log:function(){g.apply(this,arguments).level("LOG").send()},warn:function(){g.apply(this,arguments).level("WARN").send()},error:function(){g.apply(this,arguments).level("ERROR").send()},info:function(){g.apply(this,arguments).level("INFO").send()}}}function v(a){var b="eu us us2 us3 ca au ap".split(" ");if(a){if(-1<b.indexOf(a))return a;throw"Unrecognised region";}throw"No region defined";}var c={},f=function(a){if("string"!==typeof a.name)throw Error("Name not present.");
